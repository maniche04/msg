...
<html style="font-family:Calibri">
 ...
 function notifyPerms() {
  ...
  // Let's check if the user is okay to get some notification
    ...
    notifyMe("Hi <?php echo $firstname ?>","The notification system is now running, and you'll be receiving your messages here. Please do not close your browser window!",'https://cdn2.iconfinder.com/data/icons/office-general-2/64/new_message-128.png');
